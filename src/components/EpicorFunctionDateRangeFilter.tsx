...
import { EpicorFunctionDateRangePayload, TransactionDateRangePayload } from "../models";
import { hasDateQueryFields } from "../utils/transactionUtils";

const { indigo } = colors;
const CalendarWithRange = withRange(Calendar);

export type EpicorFunctionsListDateRangeFilterProps = {
...
const EpicorFunctionsListDateRangeFilter: React.FC<EpicorFunctionsListDateRangeFilterProps> = ({
  filterDateRange,
  dateRangeFilters,
  resetDateRange,
}) => {
  ...
  const dateRangeLabel = (dateRangeFields: EpicorFunctionDateRangePayload) => {
    ...
    <div>
      {!queryHasDateFields && (
        <Chip
          ...
          data-test="epicor-function-list-filter-date-range-button"
          label={"Date: ALL"}
...
export default EpicorFunctionsListDateRangeFilter;
